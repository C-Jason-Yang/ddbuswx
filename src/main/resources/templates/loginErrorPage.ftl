...
<head>
    ...
    <style>
        body{margin:0 auto; padding:0 auto; background-image:url(../../ddbus/images/bg.png);}
        input{background:none; outline:none; border:0px; }
        *{font-family:"微软雅黑"; color:white;font-size:26px;}


        .box-bg{background-image:url(../../ddbus/images/box.png); width:682px; height:430px;}
        ...
        .fillout{background-image:url(../../ddbus/images/fillout.png); width:703px; height:149px; margin-top:25px; margin-left:-10px;}
        .fillout input{width:300px; height:40px;}
        .ID{float:left; margin-left:151px; margin-top:32px;}
        .ID_box{margin-left:-130px;}
        .write_first{background-image:url(../../ddbus/images/write.png); margin-top:28px;}
        .password{float:left; margin-left:151px; margin-top:12px;}
        .password_box{margin-left:-142px;}
        .write_second{background-image:url(../../ddbus/images/write.png); margin-top:10px; margin-left:12px;}

        .login div{background-image:url(../../ddbus/images/login.png); width:223px; height:40px; padding-bottom:16px; font-size:28px;}

        #logintips{display: block; font-size: 15px; color: red;}
        .copyright span{font-size:16px; color:#9dcfff; line-height:50px;}
    </style>
    <script src="../../ddbus/js/jquery-2.1.4.min.js"></script>
    <script src="../../ddbus/js/md5.min.js"></script>
</head>
    ...
    <table border="0" cellpadding="0" cellspacing="0"  width="100%"  height="100%">
        <tr>
            <td valign="middle" align="center"	>
                <form  id="loginForm"  method="post" action="../../ddbus/index" >
                    <div class="box-bg" >
                        <div class="box" >
                            <div class="logo">
                                <span class="icon" ><img src="../../ddbus/images/icon.jpg" width="80" height="80"/></span>
